...
public final class DbConstants {
    ...
    public static final String CREATE_DATA_STATEMENT = "CREATE TABLE poi_data (id INTEGER, key TEXT, value TEXT, PRIMARY KEY (id, key));";
    public static final String CREATE_CATEGORYMAP_STATEMENT = "CREATE TABLE poi_cmap (id INTEGER, category INTEGER, PRIMARY KEY (id, category));";
    ...
    public static final String FIND_BY_DATA_CLAUSE = " AND poi_data.key = ? AND poi_data.value LIKE ? ";
    ...
    public static final String FIND_DATA_BY_ID_STATEMENT =
            "SELECT poi_data.id, poi_data.key, poi_data.value "
                    + "FROM poi_data "
                    + "poi_data.id = ?;";
    ...
    public static final String UPDATE_DATA_STATEMENT = "UPDATE poi_data SET key = ?, value = ? WHERE id = ?;";
